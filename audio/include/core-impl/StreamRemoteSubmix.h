...
class StreamInRemoteSubmix : public StreamIn, public deprecated::StreamSwitcher {
  public:
...
class StreamOutRemoteSubmix : public StreamOut, public deprecated::StreamSwitcher {
  public:
    friend class ndk::SharedRefBase;
